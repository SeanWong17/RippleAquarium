...
**交互式 Three.js 水族箱 · 鱼群行为、水面涟漪与珊瑚生长可视化**
...
**涟漪鱼缸** 是一个基于 Three.js 的交互式浏览器 3D 水族箱。

它把 boids 鱼群行为、水面高度场涟漪、珊瑚生长动画、多种鱼类外观和可折叠参数面板组合在一起。页面打开或刷新时，珊瑚会从零开始逐渐生长，鱼群会在鱼缸内持续游动，鱼靠近水面或用户点击/拖动水面都会产生可见波纹。
